...
type PopoverContentProps = React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content> & {
  ...
  /** Prevent focus from being stolen when opening the popover */
...
const PopoverContent = React.forwardRef<
  ...
  PopoverContentProps
>(({ className, align = "center", sideOffset = 4, portalled = true, container, preventFocusSteal = false, onOpenAutoFocus, ...props }, ref) => {
  const handleOpenAutoFocus = React.useCallback(
    ...
    [preventFocusSteal, onOpenAutoFocus]
  );
